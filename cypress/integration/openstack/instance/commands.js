...
Cypress.Commands.add('visitInstanceCreateForm', () => {
  cy.route(
    ...
    .route(
      'http://localhost:8080/api/service-settings/**',
      'fixture:offerings/serviceSettings.json',
    )
    .route(
      'http://localhost:8080/api/openstacktenant-images/**',
      'fixture:offerings/images.json',
    )
    .route(
      'http://localhost:8080/api/openstacktenant-flavors/**',
      'fixture:offerings/flavors.json',
    )
    .route(
      'http://localhost:8080/api/keys/**',
      'fixture:offerings/sshKeys.json',
    )
    .route(
      'http://localhost:8080/api/openstacktenant-security-groups/**',
      'fixture:offerings/securityGroups.json',
    )
    .route(
      'http://localhost:8080/api/openstacktenant-subnets/**',
      'fixture:offerings/subnets.json',
    )
    .route(
      'http://localhost:8080/api/openstacktenant-floating-ips/**',
      'fixture:offerings/floatingIps.json',
    )
    .route(
      'http://localhost:8080/api/openstacktenant-instance-availability-zones/**',
      [],
    )
