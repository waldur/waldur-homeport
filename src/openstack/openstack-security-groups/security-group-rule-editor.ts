...
const template = require('./security-group-rule-editor.html');
...
const securityGroupRuleEditor = {
  ...
  controller: class SecurityGroupRuleEditorController {
    ...
    getRulePlaceholder() {
      return translate('Security group does not contain any rule yet.');
    }

    getAddRuleMessage() {
      return translate('Add rule');
    }

    getDeleteRuleMessage() {
      return translate('Delete');
    }

    getEthernetTypeHeader() {
      return translate('Ethernet type');
    }
    ...
    getIpProtocolHeader() {
      return translate('IP protocol');
    }

    getFromPortHeader() {
      return translate('From port');
    }

    getToPortHeader() {
      return translate('To port');
    }

    getRemoteCidrHeader() {
      return translate('Remote CIDR');
    }

    getRemoteSecurityGroupHeader() {
      return translate('Remote security group');
    }
