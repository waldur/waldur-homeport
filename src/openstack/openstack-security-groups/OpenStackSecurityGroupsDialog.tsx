...
import { formatSecurityGroupProtocol, formatSecurityGroupRulePortRange } from '@waldur/openstack/openstack-security-groups/utils';
...
export const OpenStackSecurityGroupsDialog = withTranslation((props: OpenStackSecurityGroupsDialogProps) => (
              ...
              <tr key={index}>
                {index === 0 &&
                  <td rowSpan={securityGroup.rules.length}>
                    ...
                    {securityGroup.description && <div>{securityGroup.description}</div>}
                  </td>
                }
...
export default connectAngularComponent(OpenStackSecurityGroupsDialog, ['resolve']);
