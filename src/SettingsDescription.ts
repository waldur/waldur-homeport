    ...
    items: [
      {
        ...
        options: [
          ...
          { value: 'full-hero', label: 'Full Hero' },
          { value: 'gradient', label: 'Gradient' },
          { value: 'stacked', label: 'Stacked' },
          { value: 'right-split', label: 'Right Split' },
          ...
          { value: 'logo-watermark', label: 'Logo Watermark' },
          { value: 'brand-pattern', label: 'Brand Pattern' },
      ...
      },
      {
        ...
        description: translate('Video URL for the video-background layout. Supports MP4 format. Leave empty to use default video.'),
        default: '',
        type: 'url_field',
      },
      {
        key: 'LOGIN_PAGE_STATS',
        description: translate('Stats for the Stats layout. List of objects with "value" and "label" keys.'),
        default: [],
        type: 'json_list_field',
      },
      {
        key: 'LOGIN_PAGE_CAROUSEL_SLIDES',
        description: translate('Slides for the Carousel layout. List of objects with "title" and "subtitle" keys.'),
        default: [],
        type: 'json_list_field',
      },
      {
        key: 'LOGIN_PAGE_NEWS',
        description: translate('News items for the News layout. List of objects with "date", "title", "description", and "tag" keys. Supported tags: Feature, Update, Security, Announcement, Maintenance.'),
        default: [],
        type: 'json_list_field',
      },
    ],
