...
export const SettingsDescription = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: translate('Type of support backend. Possible values: atlassian, zammad.'),
        default: 'atlassian',
        type: 'string',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: translate('Project-related settings'),
        default: '',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_DEFAULT_OFFERING_ISSUE_TYPE',
        description: translate('Issue type'),
        default: 'Service Request',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_EXCLUDED_ATTACHMENT_TYPES',
        description: translate('List of attachment types'),
        default: '',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_PULL_PRIORITIES',
        description: translate('Pull priorities'),
        default: true,
        type: 'boolean',
      },
      {
        key: 'ATLASSIAN_ISSUE_TYPES',
        description: translate('Issue-related settings; Issue types'),
        default: 'Informational, Service Request, Change Request, Incident',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_AFFECTED_RESOURCE_FIELD',
        description: translate('Affected resource field'),
        default: '',
        type: 'string',
      },
      {
      ...
      },
      {
        ...
        description: translate('Impact field'),
        default: 'Impact',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_ORGANISATION_FIELD',
        description: translate('Organisation field'),
        default: '',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_RESOLUTION_SLA_FIELD',
        description: translate('Resolution SLA field'),
        default: '',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_PROJECT_FIELD',
        description: translate('Project field'),
        default: '',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_REPORTER_FIELD',
        description: translate('Reporter field'),
        default: 'Original Reporter',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_CALLER_FIELD',
        description: translate('Caller field'),
        default: 'Caller',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_SLA_FIELD',
        description: translate('SLA field'),
        default: 'Time to first response',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_LINKED_ISSUE_TYPE',
        description: translate('Type of linked issue'),
        default: 'Relates',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_SATISFACTION_FIELD',
        description: translate('Satisfaction field'),
        default: 'Customer satisfaction',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_REQUEST_FEEDBACK_FIELD',
        description: translate('Issue request feedback'),
        default: 'Request feedback',
        type: 'string',
      },
      {
        key: 'ATLASSIAN_TEMPLATE_FIELD',
        description: translate('Template field'),
        default: '',
        type: 'string',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        key: 'SMAX_API_URL',
        description: translate('Address of SMAX server. For example <http://localhost:8080/>'),
        default: '',
        type: 'string',
      },
      {
      ...
      },
      {
        ...
        description: translate('Resource field.'),
        default: '',
        type: 'string',
      },
      {
      ...
      },
      {
        ...
        description: translate('Duration of delay between server pull attempts.'),
        default: 1,
        type: 'integer',
      },
      {
        key: 'SMAX_TIMES_TO_PULL',
        description: translate('Times to pulling from backend.'),
        default: 10,
        type: 'integer',
      },
      {
