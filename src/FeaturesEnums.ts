...
export const CustomerFeatures = {
  ...
  project_requests: 'customer.project_requests',
  resource_requests: 'customer.resource_requests',
  show_domain: 'customer.show_domain',
  show_subnets: 'customer.show_subnets',
  team: 'customer.team',
};
...
export const InvitationsFeatures = {
  ...
  create_missing_user: 'invitations.create_missing_user',
  disable_multiple_roles: 'invitations.disable_multiple_roles',
