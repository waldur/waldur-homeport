      ...
      <div>
        <a onClick={this.props.openModal}>
          {this.props.selectedOption
            ? this.props.configuration.selectedValueToShow(
                this.props.selectedOption,
              )
...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    openModal: (): void =>
      dispatch(
        openListFieldModal(ownProps.configuration, ownProps.onOptionSelected),
      ),
  };
};

export const InternalListField = connect(
  null,
  mapDispatchToProps,
)(PureInternalListFieldForm);
