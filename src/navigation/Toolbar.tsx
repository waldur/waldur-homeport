      ...
      <div className="container-fluid d-flex flex-stack">
        ...
        >
          <div ref={tabsWrapperRef} className="header-menu align-items-stretch">
            <div
              className="menu menu-column menu-row menu-rounded menu-gray-700 menu-state-bg-light-primary menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-state-arrow-primary fw-bold my-5 my-lg-0 align-items-stretch"
              data-kt-menu="true"
            >
              <TabsList />
              <ExternalLinks />
