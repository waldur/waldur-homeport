...
export const DateAndTimeSelectField = (props: DateAndTimeSelectField) => (
  <div className="form-group">
    ...
    <label className={classNames('control-label', 'col-sm-1', {disabled: props.isDisabled})}>
    ...
    <Select
      ...
      onChange={(selectOpt: TimeSelect) => props.onChange(
        props.currentTime.set({ hour: selectOpt.hour, minute: selectOpt.minute }).toDate()
      )}
