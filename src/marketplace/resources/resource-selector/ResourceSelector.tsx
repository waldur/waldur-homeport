...
const ResourceSelectorDropdown: FunctionComponent<
  ResourceSelectorToggleProps
> = (props) => {
...
export const ResourceSelectorToggle: FunctionComponent<
  ResourceSelectorToggleProps
> = (props) => {
  const scroll = () => {
  ...
  return (
    <div id="resource-selector-wrapper" className="resource-selector-wrapper">
      <div
        className="resource-selector-toggle btn btn-flush d-flex align-items-center"
