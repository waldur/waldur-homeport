...
import { UsageReportContext, ResourcePlanPeriod, ComponentUsage } from './types';
...
const mapComponents = (components: ComponentUsage[]) =>
  components.reduce((collector, component) => ({
    ...collector,
    [component.type]: {
...
const mapStateToProps = (_, ownProps: Props) => ownProps.periods ? ({
  initialValues: {
    period: ownProps.periods[0],
    components: ownProps.periods[0].value ? mapComponents(ownProps.periods[0].value.components) : undefined,
  },
}) : {};
