...
const mapDispatchToProps = dispatch => ({
  showOfferingPlanDescription: planDescription => dispatch(showOfferingPlanDescription(planDescription)),
});

export const PlanDescriptionButton = connect(mapStateToProps, mapDispatchToProps)(PurePlanDescriptionButton);
