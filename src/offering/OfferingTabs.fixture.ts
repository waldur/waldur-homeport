...
export const OFFERING: Offering = {
  ...
  name: 'asas',
  project:
    'http://localhost:8080/api/projects/0b02d56ebb0d4c6cb00a0728b5d9f349/',
  type: 'oracle-iaas',
  template:
    'http://localhost:8080/api/support-offering-templates/9b9247f70d594fbfa2852c1f6d643563/',
  ...
  issue:
    'http://localhost:8080/api/support-issues/71b8d1484ba74103b7a282cb2e5f8a42/',
