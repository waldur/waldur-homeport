...
const invitationDialog = {
  ...
  controller: class InvitationDialogController {
    ...
    $onInit() {
      ...
      this.civilNumberLabel = this.ENV.invitationCivilNumberLabel || translate('Civil number');
      this.taxNumberLabel = this.ENV.invitationTaxNumberLabel || translate('Tax number');
    ...
    fetchUserDetails() {
      ...
      this.service.fetchUserDetails(this.civil_number, this.tax_number).then(response => {
        this.ncUtilsFlash.success(translate('User details have been fetched successfully.'));
