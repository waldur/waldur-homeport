// @ngInject
export default function joinServiceProjectLinkService(
  baseServiceClass,
  joinService,
) {
  let ServiceClass = baseServiceClass.extend({
    addLink: function(service_type, service_uuid, project_url) {
      let vm = this;
      return joinService
        .$get(service_type, service_uuid)
        .then(function(service) {
          return joinService
            .getServiceProjectLinkUrlByType(service_type)
            .then(function(url) {
    ...
    getServiceProjectLinks: function(
      customer_uuid,
      service_type,
      service_uuid,
    ) {
