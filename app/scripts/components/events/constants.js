export const EVENT_TEMPLATES = {
  ...
  resource_creation_scheduled: gettext('{resource_full_name} creation has been scheduled by {user_full_name}.'),
  resource_creation_succeeded: gettext('{resource_full_name} has been created by {user_full_name}.'),
  resource_deletion_failed: gettext('{resource_full_name} deletion has failed.'),
  resource_deletion_scheduled: gettext('{resource_full_name} has been scheduled to deletion by {user_full_name}.'),
  resource_deletion_succeeded: gettext('{resource_full_name} has been deleted by {user_full_name}.'),
  resource_import_succeeded: gettext('{resource_full_name} has been imported by {user_full_name}.'),
  resource_restart_failed: gettext('{resource_full_name} restart has failed.'),
  resource_restart_scheduled: gettext('{resource_full_name} has been scheduled to restart by {user_full_name}.'),
  resource_restart_succeeded: gettext('{resource_full_name} has been restarted by {user_full_name}.'),
  resource_start_failed: gettext('{resource_full_name} start has failed.'),
  resource_start_scheduled: gettext('{resource_full_name} has been scheduled to start by {user_full_name}.'),
  resource_start_succeeded: gettext('{resource_full_name} has been started by {user_full_name}.'),
  resource_stop_failed: gettext('{resource_full_name} stop has failed.'),
  resource_stop_scheduled: gettext('{resource_full_name} has been scheduled to stop by {user_full_name}.'),
  resource_stop_succeeded: gettext('{resource_full_name} has been stopped by {user_full_name}.'),
  resource_update_succeeded: gettext('{resource_full_name} has been updated by {user_full_name}.'),
  ...
  ssh_key_creation_succeeded: gettext('SSH key {ssh_key_name} has been created for user {user_full_name} with username {user_username}.'),
  ssh_key_deletion_succeeded: gettext('SSH key {ssh_key_name} has been deleted for user {user_full_name} with username {user_username}.'),
