export const EVENT_TEMPLATES = {
  ...
  auth_logged_in_with_google: gettext('User {user_username} with full name {user_full_name} authenticated successfully with {provider}.'),
  auth_logged_in_with_facebook: gettext('User {user_username} with full name {user_full_name} authenticated successfully with {provider}.'),
  auth_logged_in_with_smart_id_ee: gettext('User {user_username} with full name {user_full_name} authenticated successfully with {provider}.'),
  ...
  resource_creation_failed: gettext('Resource {resource_name} creation has failed.'),
  resource_creation_scheduled: gettext('Resource {resource_name} creation has been scheduled.'),
  resource_creation_succeeded: gettext('Resource {resource_name} has been created.'),
  resource_deletion_failed: gettext('Resource {resource_name} deletion has failed.'),
  resource_deletion_scheduled: gettext('Resource {resource_name} has been scheduled to deletion.'),
  resource_deletion_succeeded: gettext('Resource {resource_name} has been deleted.'),
  resource_import_succeeded: gettext('Resource {resource_name} has been imported.'),
  resource_restart_failed: gettext('Resource {resource_name} restart has failed.'),
  resource_restart_scheduled: gettext('Resource {resource_name} has been scheduled to restart.'),
  resource_restart_succeeded: gettext('Resource {resource_name} has been restarted.'),
  resource_start_failed: gettext('Resource {resource_name} start has failed.'),
  resource_start_scheduled: gettext('Resource {resource_name} has been scheduled to start.'),
  resource_start_succeeded: gettext('Resource {resource_name} has been started.'),
  resource_stop_failed: gettext('Resource {resource_name} stop has failed.'),
  resource_stop_scheduled: gettext('Resource {resource_name} has been scheduled to stop.'),
  resource_stop_succeeded: gettext('Resource {resource_name} has been stopped.'),
  resource_update_succeeded: gettext('Resource {resource_name} has been updated.'),
