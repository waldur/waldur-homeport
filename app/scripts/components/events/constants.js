export const EVENT_TEMPLATES = {
  ...
  ssh_key_creation_succeeded: gettext('SSH key {ssh_key_name} has been created for user {user_username}.'),
  ssh_key_deletion_succeeded: gettext('SSH key {ssh_key_name} has been deleted for user {user_username}.'),
