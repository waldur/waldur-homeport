...
export const ANALYTICS_PROJECTS_FETCH_SUCCESS = 'waldur/analytics/PROJECTS_FETCH_SUCCESS';
export const ANALYTICS_PROJECTS_FETCH_ERROR = 'waldur/analytics/PROJECTS_FETCH_ERROR';
export const ANALYTICS_SEARCH_FILTER_CHANGE = 'waldur/analytics/SEARCH_FILTER_CHANGE';
