      ...
      this.$uibModal.open({
        ...
        resolve: {
          issue: () => ({
            ...
            summary: gettext('Request custom flavour for OpenStack Tenant'),
            resource: this.tenant,
          }),
          options: {
            title: gettext('Request custom flavour for OpenStack Tenant'),
...
const openstackTenantRequestCustomFlavor = {
  template: template,
...
export default openstackTenantRequestCustomFlavor;
