import template from './expert-request-item-create.html';

const expertRequestItemCreate = {
  template,
  controller: class ExpertRequestItemCreateController {
    // @ngInject
    constructor(
      $stateParams,
      $state,
...
export default expertRequestItemCreate;
