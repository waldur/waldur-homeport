...
} from '@waldur/python-management/actionNames';
import { PythonManagementDetailsPayload } from '@waldur/python-management/types/PythonManagementPayload';
...
export const triggerRequestOutputPollingTask = createFormAction('waldur/pythonManagement/TRIGGER_REQUEST_OUTPUT_POLLING_TASK');
