...
(function() {
    var templates = {
        ...
        'ssh_key_creation_succeeded': 'SSH key {ssh_key_name} has been created in {project_name}.',
        'ssh_key_deletion_succeeded': 'SSH key {ssh_key_name} has been deleted from {project_name}.',
