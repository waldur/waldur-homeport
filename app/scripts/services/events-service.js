...
(function() {
    var templates = {
        ...
        'resource_backup_creation_failed': 'Backup creation for {resource_name} has failed.',
        'resource_backup_creation_scheduled': 'Backup for {resource_name} has been scheduled.',
        'resource_backup_creation_succeeded': 'Backup for {resource_name} has been created.',
        'resource_backup_deletion_failed': 'Backup deletion for {resource_name} has failed.',
        'resource_backup_deletion_scheduled': 'Backup deletion for {resource_name} has been scheduled.',
        'resource_backup_deletion_succeeded': 'Backup for {resource_name} has been deleted.',
        'resource_backup_restoration_failed': 'Backup restoration for {resource_name} has failed.',
        'resource_backup_restoration_scheduled': 'Backup restoration for {resource_name} has been scheduled.',
        'resource_backup_restoration_succeeded': 'Backup for {resource_name} has been restored.',
        'resource_backup_schedule_activated': 'Backup schedule for {resource_name} has been activated.',
        'resource_backup_schedule_creation_succeeded': 'Backup schedule for {resource_name} has been created.',
        'resource_backup_schedule_deactivated': 'Backup schedule for {resource_name} has been deactivated.',
        'resource_backup_schedule_deletion_succeeded': 'Backup schedule for {resource_name} has been deleted.',
        'resource_backup_schedule_update_succeeded': 'Backup schedule for {resource_name} has been updated.',
        ...
        'resource_license_added': 'License added to resource with name {resource_name}.',
...
angular.module('ncsaas').constant('EVENT_ICONS', {
    ...
    'resource_backup_creation_failed': 'resource',
    'resource_backup_creation_scheduled': 'resource',
    'resource_backup_creation_succeeded': 'resource',
    'resource_backup_deletion_failed': 'resource',
    'resource_backup_deletion_scheduled': 'resource',
    'resource_backup_deletion_succeeded': 'resource',
    'resource_backup_restoration_failed': 'resource',
    'resource_backup_restoration_scheduled': 'resource',
    'resource_backup_restoration_succeeded': 'resource',
    'resource_backup_schedule_activated': 'resource',
    'resource_backup_schedule_creation_succeeded': 'resource',
    'resource_backup_schedule_deactivated': 'resource',
    'resource_backup_schedule_deletion_succeeded': 'resource',
    'resource_backup_schedule_update_succeeded': 'resource',
    ...
    'resource_license_added': 'resource',
