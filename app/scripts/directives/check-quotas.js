        ...
        return {
            ...
            link: function(scope, element) {
                ...
                var item = scope.checkQuotas,
                    showMessage = scope.showMessage || false,
                ...
                currentStateService.getCustomer().then(function(response) {
                    ...
                    var template = '<div '+ tooltipStyle +' class="tooltip quota-tooltip" ng-show="showMessage">' +
                       ...
                       var value = response.quotas[i];
                        ...
                        if (item && value.name == item && value.limit > -1
                          && (value.limit == value.usage || value.limit == 0) && showMessage) {
                            ...
                            break;
                        } else if (item && value.name == item && value.limit > -1
                          && (value.limit == value.usage || value.limit == 0) && !showMessage) {
                            element.removeAttr('href');
                            element.addClass('disabled-view');
                            break;
